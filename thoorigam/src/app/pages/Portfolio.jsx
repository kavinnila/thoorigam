      ...
      <div className="flex">
        <div className="flex basis-1/2">
          <ul>
            ...
            <Link to="/digitalart" className="group relative w-24 h-24"> Digital Art</Link> 
            </li>
            <li className="text-7xl font-extralight border-t border-solid border-black mx-30 p-10 transition-all last-of-type:border-b group-hover:opacity-90">
            <Link to="/creations" className="group relative w-24 h-24">  Creations</Link> 
            </li>
            <li className="text-7xl font-extralight border-t border-solid border-black mx-30 p-10 transition-all last-of-type:border-b group-hover:opacity-90">
            <Link to="/photography" className="group relative w-24 h-24"> Photography</Link> 
            </li>
            {/* <li className="text-7xl font-extralight border-t border-solid border-black mx-30 p-10 transition-all last-of-type:border-b group-hover:opacity-90">
            <Link to="/tshirts" className="group relative w-24 h-24"> Tshirts</Link> 
            </li> */}
          </ul>
        </div>
      </div>
